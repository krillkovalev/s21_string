...
START_TEST(test_sscanf_4) {
  ...
  result_origin = sscanf("Today is tuesday", "%3s %*s %5s", str3, str4);
  ck_assert_int_eq(result, result_origin);
  ck_assert_str_eq(str1, str3);
  ck_assert_str_eq(str2, str4);
}
...
START_TEST(test_sscanf_8) {
  int result = 0, result_origin = 0;
  short sh_num_1 = 0, sh_num_2 = 0, sh_num_3 = 0, sh_num_4 = 0, sh_num_5 = 0,
        sh_num_6 = 0;
  result =
...
START_TEST(test_sscanf_9) {
  ...
  result =
      s21_sscanf("234567890987654356789 0xDEF", "%ld %li", &l_num1, &l_num2);
  result_origin =
      s21_sscanf("234567890987654356789 0xDEF", "%ld %li", &l_num3, &l_num4);

  float num_1 = 0., num_2 = 0., num_3 = 0., num_4 = 0., num_5 = 0., num_6 = 0.,
        num_7 = 0.;
  float num_8 = 0., num_9 = 0., num_10 = 0., num_11 = 0., num_12 = 0.,
        num_13 = 0., num_14 = 0.;
...
START_TEST(test_sscanf_28) {
  ...
  char a = '\0', b = '\0';
  int result =
      s21_sscanf("aboba % 1567 @", "%s  %% %d %c %n", str_n, &num1, &a, &num2);
  int result_origin =
      sscanf("aboba % 1567 @", "%s %% %d %c %n", str_n_orig, &num3, &b, &num4);
  ck_assert_int_eq(result, result_origin);
